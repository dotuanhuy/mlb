            ...
            <div className='mlbbackpack-container px-4'>
                <div className='title text-center'>
                    <h2 className='title-mlbbackpack mb-4'>
                        <Link to={path.BACKPACK} state={{typeName: typeBagBalo.BACKPACK}}>MLB BACK PACK</Link>
                    </h2>
                    <p>Balo mới nhất tại <Link to={path.BACKPACK} state={{typeName: typeBagBalo.BACKPACK}}>MLB Việt Nam</Link></p>
                </div>
                <div className='menu-box'>
                    ...
                    <div className='view-all text-center'>
                        <Link to={path.BACKPACK} state={{typeName: typeBagBalo.BACKPACK}}>Xem tất cả</Link>
                    </div>
                </div>  
            </div>
        </div>
