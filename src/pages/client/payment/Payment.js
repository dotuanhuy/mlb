...
import Paypal from '../../../components/clients/paypal/Paypal';
...
function Payment({ titlePage }) {
    ...
    const { message, orderId, errCode } = useSelector(state => state.order)
    ...
    const handleOnchangeShipping = (e) => {
        setShippingType({
            type: e.target.value,
            value: e.target.value === 'cod' ? 0 : 35000
        })
    }
                                            ...
                                            return (
                                                <div key={index} className='d-flex align-items-center justify-content-center gap-1 mb-4 px-4 pt-2'>
                                                    ...
                                                    <div className='col-8' style={{ 'lineHeight': 1.2 }}>
                                                        <span className='fs-14 fw-500'>{item?.name}</span>
                                                        <div>
                                                            {
